...
Most functions used inside jupyter_notebooks/... are stored in irrigation_detection.py and tools.py .
...
[Yellowbrick | Extend Sklearn with Visualizations API](https://www.scikit-yb.org/en/latest/index.html)
